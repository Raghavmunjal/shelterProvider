    ...
    <script>
        $(document).ready(function() {
           // var c1 = 0;
            ...
            /*function ajaxmob(getmobb) {
                var urll = "dr-register-ajax.php?data=" + getmobb + "&what=mob";
                $.get(urll, function(response) {
                    ...
                    } else if (response == "Taken" && $("#mobjasus").val() == getmobb) {
                        c1 = 1;
                        $("#mob").addClass("ok").removeClass("notok");
                        $("#errmob").html("");
                    } else {
            ...
            function ajaxmail(getemail) {
                var url = "dr-register-ajax.php?data=" + getemail + "&what=email";
            ...
            $("#search").click(function() {
                ...
                $("#dname").removeClass("notok").removeClass("ok");
                $("#mob").removeClass("notok").removeClass("ok");
                $("#uni").removeClass("notok").removeClass("ok");
                $("#spl").removeClass("notok").removeClass("ok");
                $("#qua").removeClass("notok").removeClass("ok");
                $("#hospital").removeClass("notok").removeClass("ok");
                $("#address").removeClass("notok").removeClass("ok");
                $("#state").removeClass("notok").removeClass("ok");
                $("#city").removeClass("notok").removeClass("ok");
                $("#exp").removeClass("notok").removeClass("ok");
                ...
                $.getJSON("dr-register-json.php?username=" + userid, function(jsonAryResponse) {
                    ...
                    if (jsonAryResponse.length == 0) {
                        ...
                        $("#emailjasus").val(jsonAryResponse[0].email);

                        $("#dname").val(jsonAryResponse[0].name);

                        $("#jasus").val(jsonAryResponse[0].ppic);

                        $("#jasuss").val(jsonAryResponse[0].cpic);

                        $("#prev").prop("src", "uploads/" + jsonAryResponse[0].ppic);

                        $("#showc").prop("src", "uploads/" + jsonAryResponse[0].cpic);
                        ...
                        $("#uni").val(jsonAryResponse[0].university);

                        $("#spl").val(jsonAryResponse[0].specialization);

                        $("#qua").val(jsonAryResponse[0].qualification);

                        $("#hospital").val(jsonAryResponse[0].hospital);
            ...
            $("#exp").blur(function() {
                ...
                //alert(getexp)
                if (getexp == "") {
                    $("#errexp").html("Please fill your work experience");
                    $(this).addClass("notok").removeClass("ok");
                    e = 0;
                } else if (getexp >= 0) {
                    ...
                    $("#errexp").html("Please check your work experience");
                    $(this).addClass("notok").removeClass("ok");
                    e = 0;
                }
            ...
            $("#uni").blur(function() {
                var getuni = $(this).val();
                var nametest = /^[a-zA-Z ]*$/;
                var result = nametest.test(getuni);
                if (getuni == "") {
                    $("#erruni").html("Please fill your University");
                    $(this).addClass("notok").removeClass("ok");
                    f = 0;
                } else if (result == false) {
                    $("#erruni").html("Invalid Name of University");
                    $(this).addClass("notok").removeClass("ok");
                    f = 0;
                } else {
                    $("#erruni").html("");
            ...
            $("#qua").blur(function() {
                var getqua = $(this).val();
                var nametest = /^[a-zA-Z ]*$/;
                var result = nametest.test(getqua);
                if (getqua == "") {
                    $("#errqua").html("Please fill your Qualifications");
                    $(this).addClass("notok").removeClass("ok");
                    g = 0;
                } else if (result == false) {
                    $("#errqua").html("Invalid Qualification");
                    $(this).addClass("notok").removeClass("ok");
                    g = 0;
                } else {
                    $("#errqua").html("");
            ...
            $("#hospital").blur(function() {
                var gethos = $(this).val();
                var nametest = /^[a-zA-Z ]*$/;
                var result = nametest.test(gethos);
                if (gethos == "") {
                    $("#errhos").html("Please fill your hospital name");
                    $(this).addClass("notok").removeClass("ok");
                    h = 0;
                } else if (result == false) {
                    $("#errhos").html("Invalid Name of Hospital");
                    $(this).addClass("notok").removeClass("ok");
                    h = 0;
                } else {
                    $("#errhos").html("");
            ...
            $("#save").click(function(ev) {
                ...
                if (a == 1 && b == 1 && b1 == 1  && c == 1 && d == 1 && e == 1 && f == 1 && g == 1  && h == 1 && i == 1 && j == 1 && k == 1 && getcpic != "" && getppic != "") {
                    ...
                    alert("please check your work experience");
                    $("#exp").focus();
                    ev.preventDefault();
                } else if (f == 0) {
                    alert("please check your university name");
                    $("#uni").focus();
                    ev.preventDefault();
                } else if (g == 0) {
                    ...
                    alert("please check your Hospital name");
                    $("#hospital").focus();
                    ev.preventDefault();
                } else if (i == 0) {
                    ...
                    alert("please check your specilaization");
                    $("#spl").focus();
                    ev.preventDefault();
                } else if (k == 0) {
            ...
            $("#update").click(function(ev) {
               ...
               // alert(c1);
                ...
                var gethos = $("#hospital").val();
                var hostest = /^[a-zA-Z ]*$/;
                var res = hostest.test(gethos);
                if (gethos == "") {
                    h = 0;
                } else if (res == false) {
                    h = 0;
                ...
                if (b == 0 || b1 == 0) {
                    ...
                    $("#mob").focus();
                    ev.preventDefault();
                } else if (a == 1 && d == 1 && e == 1 && f == 1 && g == 1 && h == 1 && i == 1 && j == 1 && k == 1 && getcpic != "" && getppic != "" && b == 1 && c == 1 && b1 == 1) {
                    alert(" Updated ");
                } else if (a == 0) {
                    alert("please check your name");
                    $("#dname").focus();
...
<body class="bgg">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a class="closebtn" onclick="closeNav()" style="font-size: 40px;cursor: pointer;margin-left: 220px;margin-top: 450px;">&times;</a>
    ...
    <form action="dr-register-process.php" method="post" enctype="multipart/form-data" style="margin-top: 120px;">
        <div class="container">
                ...
                <div class="col-sm-12">
                    <fieldset class="border border-dark p-4">
                        ...
                        <div class="row">
                            ...
                            &nbsp;
                            <div class="col-sm-5">
                                <input type="text" name="dname" class="form-control" id="dname" placeholder="Name" required>
                        ...
                        <div class="row">
                            ...
                            &nbsp;
                            <div class="col-sm-5">
                                <input type="number" name="exp" class="form-control" id="exp" placeholder="Work Experience" required>
                                <small id="errexp" class="form-text text-muted"></small>
                            </div>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <fieldset class="border border-dark p-4">
                        <legend class="w-auto">Education Details</legend>
                        <div class="row">
                            <div class="col-sm-10 offset-1">
                                <input type="text" name="uni" class="form-control" id="uni" placeholder="University" required>
                                <small id="erruni" class="form-text text-muted"></small>
                            </div>
                        </div>
                        &nbsp;
                        <div class="row">
                            <div class="col-sm-10 offset-1">
                                <input type="text" name="qua" class="form-control" id="qua" placeholder="Qualification" required>
                                <small id="errqua" class="form-text text-muted"></small>
                            </div>
                        </div>
                        &nbsp;
                        <div class="row">
                            <div class="col-sm-10 offset-sm-1">
                                <select name="spl" class="custom-select" id="spl" required>
                ...
                <div class="col-sm-6">
                    <fieldset class="border border-dark p-4" style="height:99%">
                        ...
                        <div class="row">
                            <div class="col-sm-10 offset-1">
                                <input type="text" name="hospital" class="form-control" id="hospital" placeholder="Hospital/Clinic Name" required>
                                <small id="errhos" class="form-text text-muted"></small>
                            </div>
                        </div>
                        &nbsp;
                        <div class="row">
            ...
            <div class="row" style="margin-left: 20px;">
                <div class="col-sm-3">
                    ...
                    <div class="card border-dark" style="width: 18rem;height:19rem;">
                        <img src="picss/profile.png" id="prev" class="card-img-top" style="height:150px; width:150px; margin-left:70px; margin-top:30px; margin-bottom:30px;" required>

                        <div class="card-body">
                            <label>
                                <input type="file" accept="image/*" onchange="showpreview(this);" name="ppic" id="ppic" multiple class="form-control">
                                <span class="btn btn-primary btn-md btn-block" id="profile" style="margin-left:40px; margin-top: 11px;">Upload Profile</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-3 offset-sm-1">
                    <div class="card border-dark" style="width: 18rem;height:19rem;">
                        <img src="picss/certificate.jpg" id="showc" class="card-img-top" style="height:150px; width:140px; margin-left:80px; margin-top:40px; margin-bottom:30px;border:1px solid lightgray;" required>

                        <div class="card-body">
                            <label>
                                <input type="file" accept="image/*" onchange="showcertificate(this);" name="cpic" id="cpic" multiple class="form-control">
                                <span class="btn btn-primary btn-md btn-block" id="certi" style="margin-left:35px">Upload Certificate</span>
                            </label>
                        </div>
                    </div>
                </div>
